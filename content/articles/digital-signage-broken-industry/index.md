...
## tl;dr;
The digital signage industry is a “zombie” that survives only because customers don't know any better.
They do poor marketing, drowning in self-praise and hollow buzzwords that miss the target audience entirely. Communication channels overflow with relentless hardware spam and shallow product pitches, creating an industry-wide transparency problem. The paradoxical irony? An industry selling communication tools that can't communicate worth a damn.
...
This article captures my observations after 15+ years programming digital signage solutions and running [SmilControl](https://smil-control.com).

![AI created](information-desert.jpg)
...
Instead of genuine communication that addresses actual customer pain points, the industry drowns in self-congratulation and buzzword bingo. Blogs stuffed with stock photos and hollow statements that say absolutely nothing. The situation has improved slightly in recent years, but [AI](https://dev.to/sagiadinos/stop-calling-llms-ai-1ihk) threatens to make it exponentially worse.
...
Want examples?
In April 2025, a Reddit user launched a comprehensive, curated list of digital signage companies at [https://signagelist.org](https://signagelist.org). Free to access. Building and maintaining something like that requires serious work and passion.
...
![AI created](fistful-of-dollars.jpg)

In my early years writing articles and developing [open source digital signage software](https://garlic-signage.com) I reached out to industry press trying to place guest articles or gain some coverage.
...
DigitalSignageToday was an exception: they forwarded my information to a sales agency, who then contacted me offering to write a "professional article" (paid, naturally) that might get placed somewhere. Instead of editorial consideration, I got a sales pitch.
...
During Covid19 lockdowns in 2020, I built an [Open Source Android Launcher](https://garlic-signage.com/garlic-launcher/) for maintaining digital signage media players without rooting the underlying Android OS.
...
Some months later, I stumbled across [this article ](https://invidis.de/2020/09/mirabyte-frontface-gratis-tool-macht-windows-pc-zum-digital-signage-player/) about a company offering a similar solution for Windows. Good for them getting that coverage.

My open source press release? Silence. Their solution? Featured article.

Makes you wonder about editorial selection criteria.

Sure, similar dynamics exist in many industries. But I doubt anywhere else operates quite so transparently obvious as digital signage.
...
In 2018, Capterra offered me vouchers to distribute to customers in exchange for reviews on their platform. Pay-to-play "independent" comparison.
...
Companies endlessly talk about "vision" and "innovation." But the only genuine innovation I've seen in digital signage came around 2010 from Taiwanese company [IAdea](https://www.iadea.com).
...
So I built the [garlic-player](https://garlic-signage.com/garlic-player/) as a foundation they could use to assemble their own hardware solutions properly.
...
The pattern was clear: this industry doesn't collaborate, it hoards. So I stopped wasting time seeking partnerships and built what I needed myself for my customers: A complete open source software ecosystem for my customers. You'll find it on [GitHub](https://github.com/garlic-signage/) and [GarlicSignage](https://garlic-signage.com)
